...
namespace DSS.DSS.Controls
{
    public partial class Menu : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            /*
            if (((Label)Parent.FindControl("_LBL_ModelView")).Text == "0")
                _PNL_Model.Visible = false;
            if (((Label)Parent.FindControl("_LBL_ModelingView")).Text == "0")
                _PNL_Modeling.Visible = false;*/
        }
    }
}